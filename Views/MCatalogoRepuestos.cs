...
namespace TALLERM.View
{
    public partial class MCatalogoRepuestos : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            MCatalogoRepuestos_modal m = new MCatalogoRepuestos_modal(-1, controller);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (dataGridView1.RowCount > 0)
            {
                if (dataGridView1.SelectedRows.Count > 0)
                {
                    ...
                    MCatalogoRepuestos_modal ag_elemento = new MCatalogoRepuestos_modal(pid, controller);
