...
{
    public partial class MGestionConductores : Form
    {
        GestionEncargadosController controller = new GestionEncargadosController();
        public MGestionConductores()
        {
            InitializeComponent();
        }
        ...
        {
            MGestionConductores_modal m = new MGestionConductores_modal(-1, controller);
        ...
        private void ActualizarDataGridV()
        {
            ...
            {
                WarnToBinnacle.SaveToBinnacle("MGestionConductores.Form-ActualizarDataGridV", ex.ToString());
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (dataGridView1.RowCount > 0)
            {
                if (dataGridView1.SelectedRows.Count > 0)
                {
                    ...
                    MGestionConductores_modal ag_elemento = new MGestionConductores_modal(pid, controller);
