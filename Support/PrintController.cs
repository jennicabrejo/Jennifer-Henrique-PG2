...
namespace TALLERM.Support
{
    ...
    class DataGridViewPrinter
    {
        ...
        public DataGridViewPrinter(DataGridView aDataGridView,
            ...
            string aTitleText, string aSubTitleText, string aTotalText, Font aTitleFont,
            Font aSubTitleFont, Color aTitleColor, bool WithPaging)
        {
            ...
            TheSubTitleText = aSubTitleText;
            TheTotalText = aTotalText;
            TheTitleFont = aTitleFont;
            TheSubTitleFont = aSubTitleFont;
        ...
        private void DrawHeader(Graphics g)
        {
            ...
            if (IsWithPaging)
            {
                ...
                RectangleF PageStringRectangle2 =
                new RectangleF((float)LeftMargin, CurrentY,
                (float)PageWidth - (float)RightMargin - (float)LeftMargin,
                g.MeasureString(DateTimeNow, PageStringFont).Height);

                g.DrawString(DateTimeNow, PageStringFont,
                   new SolidBrush(Color.Black),
                   PageStringRectangle2, PageStringFormat);

                CurrentY += g.MeasureString(DateTimeNow,
            ...
            if (IsWithTitle)
            {
                ...
                RectangleF TitleRectangle2 = new RectangleF((float)LeftMargin, CurrentY, (float)PageWidth - (float)RightMargin - (float)LeftMargin, g.MeasureString(TheSubTitleText, TheSubTitleFont).Height);

                g.DrawString(TheSubTitleText, TheSubTitleFont, new SolidBrush(TheTitleColor), TitleRectangle2, TitleFormat);

                CurrentY += g.MeasureString(TheSubTitleText, TheSubTitleFont).Height;


                //BR
                RectangleF TitleRectangle3 = new RectangleF((float)LeftMargin, CurrentY, (float)PageWidth - (float)RightMargin - (float)LeftMargin, g.MeasureString("  ", TheSubTitleFont).Height);

                g.DrawString("  ", TheSubTitleFont, new SolidBrush(TheTitleColor), TitleRectangle3, TitleFormat);

                CurrentY += g.MeasureString("  ", TheSubTitleFont).Height;
            }
        ...
        private bool DrawRows(Graphics g)
        {
            ...
            //TOTAL FORMAT
            StringFormat TitleFormat2 = new StringFormat();
            TitleFormat2.Trimming = StringTrimming.Word;
            TitleFormat2.FormatFlags = StringFormatFlags.NoWrap |
                StringFormatFlags.LineLimit | StringFormatFlags.NoClip;
            if (IsCenterOnPage)
                TitleFormat2.Alignment = StringAlignment.Center;
            else
                TitleFormat2.Alignment = StringAlignment.Near;
            ...
            g.DrawString("  ", TheSubTitleFont, new SolidBrush(TheTitleColor), TitleRectangle3, TitleFormat2);

            CurrentY += g.MeasureString("  ", TheSubTitleFont).Height;

            //TOTAL
            RectangleF TitleRectangle4 = new RectangleF((float)LeftMargin, CurrentY, (float)PageWidth - (float)RightMargin - (float)LeftMargin, g.MeasureString(TheTotalText, TheSubTitleFont).Height);

            g.DrawString(TheTotalText, TheSubTitleFont, new SolidBrush(TheTitleColor), TitleRectangle4, TitleFormat2);

            CurrentY += g.MeasureString(TheTotalText, TheSubTitleFont).Height;
        ...
        public bool DrawDataGridView(Graphics g)
        {
            ...
            {
                WarnToBinnacle.SaveToBinnacle("PrintController", ex.ToString());

                MessageBox.Show("No fue posible imprimir el documento: " + ex.ToString(),
